...
>NOTE: Envriorinment name is used as a prefix to the azure resources and hence [Azure naming restrictions](https://docs.microsoft.com/en-us/azure/azure-resource-manager/management/resource-name-rules) are applied to the resulting name of the resources.
